...
export async function generateServiceReportSharedChrome(
  ...
  const data: ServiceReportPdfData = {
    ...
    customer: {
      trade_name: customer || null, legal_name: null, alias: null,
      account_number: null, trn: null, group_name: null,
      branch_name: job.branch_name ?? null, address: job.address ?? null,
      emirate: null, po_box: null,
      contact_name: null, contact_phone: null,
      contact_secondary: null, email: null,
      rep_name: null, rep_designation: null, rep_contact: null,
    },
    supervisor: null,
    team: [],
    premisesType: job.service_type ?? null,
    pestEvidence: [],
    infestationLevel: null,
    areasTreated: [],
    specificAreasDetail: null,
    accessRestrictions: job.access_notes ?? null,
    ...
    trend: [],
    mostFlaggedIssue: null,
    notes: notesParts.join("\n"),
    financials: {
      months_guaranteed: null, yearly_contract: null, next_service_due: null,
      amount_excl_vat: null, vat_amount: null, total_incl_vat: null,
      amount_received: null, payment_method: null, balance_due: null,
    },
    signatureCustomer: null,
    signatureCustomerCaptured: false,
    signatureTechnician: null,
    signatureTechnicianCaptured: false,
    verifyUrl: null,
    brand: PEST_SKIN,
    org: ORG,
    logo,
