-- 070_notification_guard_fix.sql
-- customer_id is a reference link like job/contract/branch (069) — the ON DELETE
-- SET NULL cascade must not trip the content-immutability guard. Content =
-- kind, recipient, subject, body, attachment, resend_of, created_at.
